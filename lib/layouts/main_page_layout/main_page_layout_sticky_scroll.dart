...
class MainPageLayoutStickyScroll extends StatefulWidget {
  ...
  const MainPageLayoutStickyScroll({
    super.key, 
  ...
  @override
  State<MainPageLayoutStickyScroll> createState() => _MainPageLayoutStickyScrollState();
}


class _MainPageLayoutStickyScrollState extends State<MainPageLayoutStickyScroll> {
  int _tabBarIndex = 0;
